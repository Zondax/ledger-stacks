...
mod test {
    ...
    const VERSIONED_CONTRACT_HEX: &str = "";

    #[test]
    fn parse_versioned_contract() {
        let bytes = hex::decode(VERSIONED_CONTRACT_HEX).unwrap();
        let mut msg = ParsedObj::from_bytes(&bytes).unwrap();
        msg.read(&bytes).unwrap();
        ParsedObj::validate(&mut msg).unwrap();
    }
    ...
    #[test]
    fn parse_versioned_contract_future_clarity_version() {
        // same vector but with the clarity version byte (right after the 0x06
        // payload-type tag) set to 6, a version newer than any the app knows about.
        // "060210" -> "060610" (0x10 = contract name length, 16)
        let input = VERSIONED_CONTRACT_HEX.replacen("0602107468656e", "0606107468656e", 1);
        let bytes = hex::decode(input).unwrap();
        let mut msg = ParsedObj::from_bytes(&bytes).unwrap();
        msg.read(&bytes).unwrap();
        ParsedObj::validate(&mut msg).unwrap();
    ...
    #[test]
    fn reject_versioned_contract_clarity_version_zero() {
        let input = VERSIONED_CONTRACT_HEX.replacen("0602107468656e", "0600107468656e", 1);
        let bytes = hex::decode(input).unwrap();
        assert!(ParsedObj::from_bytes(&bytes).is_err());
    }
