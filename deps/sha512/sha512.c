...
static void mbedtls_sha512_init(sha512_256_ctx *ctx) {
 ...
 */
static void mbedtls_sha512_starts(sha512_256_ctx *ctx) {
    ctx->total[0] = 0;
    ctx->total[1] = 0;
...
static void mbedtls_sha512_process(sha512_256_ctx *ctx,
 ...
 */
static void mbedtls_sha512_update(sha512_256_ctx *ctx,
 ...
 */
static void mbedtls_sha512_finish(sha512_256_ctx *ctx,
...
void SHA512_256_starts(sha512_256_ctx *ctx) {
    mbedtls_sha512_starts(ctx);
}

void SHA512_256_update(sha512_256_ctx *ctx, const uint8_t *input, size_t ilen) {
    mbedtls_sha512_update(ctx, input, ilen);
}

void SHA512_256_finish(sha512_256_ctx *ctx, uint8_t out[SHA512_DIGEST_LENGTH]) {
