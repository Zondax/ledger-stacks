...
This project contains the Blockstack app for Ledger Nano S and X.
...
Download a release from here (https://github.com/Zondax/ledger-blockstack/releases). You only need `installer_s.sh`
